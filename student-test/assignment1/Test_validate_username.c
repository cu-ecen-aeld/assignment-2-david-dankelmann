...
void test_validate_my_username()
{
    ...
    const char *malloced_username = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, malloced_username, "Usernames do not match");
}
